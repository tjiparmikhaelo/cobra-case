          ...
          */}
          ...
          sm:gap-6">
            ...
            */}
            ...
            text-gray-900">
              ...
              */}
              ...
              <span className="relative px-2">
                customers
                <Icons.underline className="hidden sm:block
            ...
            {/*
            width of 24
            order 0 -> the snake image will appear before/ above the h2 tag
            large device order-2 -> the snake image will appear after the h2 tag
            */}
          </div>
          ...
          lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            grid display
            max width of 2 xl
            grid column with spacing of 1 equally accros items
            padding x of 4
            large devices -> margin x of 0
            large devices -> none max width
            large devices -> grid column with spacing of 2 equally across the items
            gap y of 16
            */}
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              flex column
              gap of 4
              large devices -> padding right of 8
              extra large devices -> padding right of 20
              */}
              ...
              <div className="flex gap-4 mt-2">
                ...
                margin top of 2
                */}
                <img src="/users/user-1.png" alt="user" 
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              */}
              ...
              <div className="text-lg leading-8">
                ...
                */}
                <p>
                  ...
                  and that led to some pretty heavy scracthmarks on all of my last
              ...
              <div className="flex gap-4 mt-2">
                ...
                margin top of 2
                */}
                <img src="/users/user-4.jpg" alt="user" 
                className="rounded-full h-12 w-12 object-cover"/>
                <div className="flex flex-col">
                  <p className="font-semibold">Theofilus</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600"/>
                    <p className="text-sm">Verified Purchase</p>
                  </div>
